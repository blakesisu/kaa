    ...
    <div class="proj__dual-projects">
      <div class="proj-projects__project proj-project__dual">
        <picture class="proj-project__picture">
          ...
          <img class="proj-project__img" srcset="<?php bloginfo('template_url'); ?>/images/projects/desktop/31ststreet-lg.jpg" alt="">
        </picture>
      ...
      <div class="proj-projects__project proj-project__dual">
        <picture class="proj-project__picture">
          ...
          <img class="pd-related-project__img proj-project__img" srcset="<?php bloginfo('template_url'); ?>/images/projects/desktop/18thwalk-lg.jpg" alt="">
        </picture>
        <div class="proj-project__description">
