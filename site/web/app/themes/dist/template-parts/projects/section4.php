    ...
    <div class="proj__tri-projects">
      <div class="proj-projects__project proj-project__tri">
        <picture class="proj-project__picture">
          ...
          <img class="proj-project__img" srcset="<?php bloginfo('template_url'); ?>/images/projects/desktop/sanremo-lg.jpg" alt="">
        </picture>
      ...
      <div class="proj-projects__project proj-project__tri">
        <picture class="proj-project__picture">
          ...
          <img class="pd-related-project__img proj-project__img" srcset="<?php bloginfo('template_url'); ?>/images/projects/desktop/6thStreet-lg.jpg" alt="">
        </picture>
        <div class="proj-project__description">
      ...
      <div class="proj-projects__project proj-project__tri">
        <picture class="proj-project__picture">
          ...
          <img class="pd-related-project__img proj-project__img" srcset="<?php bloginfo('template_url'); ?>/images/projects/desktop/beverlyhills-lg.jpg" alt="">
        </picture>
        <div class="proj-project__description">
