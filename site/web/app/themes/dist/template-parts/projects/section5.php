    ...
    <div class="proj__dual-projects">
      <div class="proj-projects__project proj-project__dual">
        <picture class="proj-project__picture">
          ...
          <img class="proj-project__img" srcset="<?php bloginfo('template_url'); ?>/images/projects/desktop/34th-lg.jpg" alt="">
        </picture>
        <div class="proj-project__description">
          <h3 class="proj-text-mini__header">34TH & THE STRAND</h3>
        </div>
      </div>
      ...
      <div class="proj-projects__project proj-project__dual">
        <picture class="proj-project__picture">
          ...
          <img class="pd-related-project__img proj-project__img" srcset="<?php bloginfo('template_url'); ?>/images/projects/desktop/trophyhills-lg.jpg" alt="">
        </picture>
        <div class="proj-project__description">
          <h3 class="proj-text-mini__header">TROPHY HILLS</h3>
        </div>
      </div>
