<section class="pd-grid pd-grid--half pd-grid--image-right">
  ...
  <div class="pd-grid__block pd-grid__block--image">
    <picture class="pd-grid__picture">
      ...
      <img class="pd-grid__img" srcset="<?php bloginfo('template_url'); ?>/images/details/grid-3/details-kitchen-lg.jpg" alt="">
    </picture>
  </div>
