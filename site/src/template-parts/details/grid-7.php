<section class="details-grid details-grid--7">
  <div class="details-horizontal__content">

    <!-- Text Block -->
    <div class="details-headline-block">
      <div class="details-headline-block__content">
        <h1 class="details-headline-block__header">RELATED PROJECTS</h1>
        <div class="details-headline-block__dash"></div>
      </div>
    </div>
