    ...
    <div class="proj__dual-projects">
      <a href="#" class="proj-projects__project proj-project__dual">
        <picture class="proj-project__picture">
          ...
          <img class="proj-project__img" srcset="<?php bloginfo('template_url'); ?>/images/projects/desktop/3rdStreet-lg.jpg" alt="">
        </picture>
      ...
      <a href="#" class="proj-projects__project proj-project__dual">
        <picture class="proj-project__picture">
          ...
          <img class="pd-related-project__img proj-project__img" srcset="<?php bloginfo('template_url'); ?>/images/projects/desktop/7thWalkstreet-lg.jpg" alt="">
        </picture>
        <div class="proj-project__description">
