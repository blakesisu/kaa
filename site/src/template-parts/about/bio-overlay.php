  ...
  <div class="popup-inner about-inline">
    ...
    <div class="about-bio-overlay__right about-horizontal">
      <div class="about-value-text-column">
        <h2 class="about-value-header">GRANT KIRKPATRICK</h2>
        <h3 class="about-join-title">FOUNDING PARTNER</h3>
        <h2>
...
<section class="popup about-bio-overlay" data-popup="baker">
  <div class="popup-inner about-inline">
    ...
    <div class="about-bio-overlay__right about-horizontal">
      <div class="about-value-text-column">
        <h2 class="about-value-header">PATTI BAKER</h2>
        <h3 class="about-join-title">PRINCIPAL</h3>
        <h2>
          <div class="about-text-block__dash"></div>
          <p class="about-value-content">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quesque volutpat mattis eros. Nullam malesuada era ut turpis. Suspendisse urna nibh, viverra non, semper suscipit.</p>
        </h2>
...
<section class="popup about-bio-overlay" data-popup="straughan">
  <div class="popup-inner about-inline">
    ...
    <div class="about-bio-overlay__right about-horizontal">
      <div class="about-value-text-column">
        <h2 class="about-value-header">STEVE STRAUGHAN</h2>
        <h3 class="about-join-title">DESIGN COORDINATOR</h3>
        <h2>
          <div class="about-text-block__dash"></div>
          <p class="about-value-content">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quesque volutpat mattis eros. Nullam malesuada era ut turpis. Suspendisse urna nibh, viverra non, semper suscipit.</p>
        </h2>
...
<section class="popup about-bio-overlay" data-popup="copeland">
  <div class="popup-inner about-inline">
    ...
    <div class="about-bio-overlay__right about-horizontal">
      <div class="about-value-text-column">
        <h2 class="about-value-header">LISA COPELAND</h2>
        <h3 class="about-join-title">CFO</h3>
        <h2>
          <div class="about-text-block__dash"></div>
          <p class="about-value-content">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quesque volutpat mattis eros. Nullam malesuada era ut turpis. Suspendisse urna nibh, viverra non, semper suscipit.</p>
        </h2>
...
<section class="popup about-bio-overlay" data-popup="mcgowan">
  <div class="popup-inner about-inline">
    ...
    <div class="about-bio-overlay__right about-horizontal">
      <div class="about-value-text-column">
        <h2 class="about-value-header">MICHAEL MCGOWAN</h2>
        <h3 class="about-join-title">LANDSCAPE STUDIO DIRECTOR</h3>
        <h2>
          <div class="about-text-block__dash"></div>
          <p class="about-value-content">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quesque volutpat mattis eros. Nullam malesuada era ut turpis. Suspendisse urna nibh, viverra non, semper suscipit.</p>
        </h2>
...
<section class="popup about-bio-overlay" data-popup="beckmann">
  <div class="popup-inner about-inline">
    ...
    <div class="about-bio-overlay__right about-horizontal">
      <div class="about-value-text-column">
        <h2 class="about-value-header">MEGHAN BECKMANN</h2>
        <h3 class="about-join-title">PROJECT MANAGER</h3>
        <h2>
          <div class="about-text-block__dash"></div>
          <p class="about-value-content">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quesque volutpat mattis eros. Nullam malesuada era ut turpis. Suspendisse urna nibh, viverra non, semper suscipit.</p>
        </h2>
...
<section class="popup about-bio-overlay" data-popup="paolillo">
  <div class="popup-inner about-inline">
    ...
    <div class="about-bio-overlay__right about-horizontal">
      <div class="about-value-text-column">
        <h2 class="about-value-header">TODD PAOLILLO</h2>
        <h3 class="about-join-title">SR. PROJECT MANAGER</h3>
        <h2>
          <div class="about-text-block__dash"></div>
          <p class="about-value-content">Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Donec odio. Quesque volutpat mattis eros. Nullam malesuada era ut turpis. Suspendisse urna nibh, viverra non, semper suscipit.</p>
        </h2>
